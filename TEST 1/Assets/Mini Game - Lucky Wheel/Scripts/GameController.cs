...
namespace FortuneWheel
{
    public class GameController : MonoBehaviour
    {
        ...
        public class PieceFeatures
        {
            ...
            public int rewardChance;            //Chance to give this slot as result reward if this property is 100 at every slot than every reward has %8.3 change to be selected at 12 sector fortune wheel.
        ...
        private float[] sectorsAngles = new float[] { -30, -60, -90, -120, -150, -180, -210, -240, -270, -300, -330, -360 }; //Fill the necessary angles (for example if you want to have 8 sectors you need to fill the angles with 45 degrees step) 
